...
import com.mytest.test.ct.Check_Chicken_Store;
...
public class Crawl_Yogiyo_Chicken{
   public static void main(String[] args) {
      // 현재 package의 workspace 경로, Windows는 [ chromedriver.exe ]
        ...
        WebElement menu=driver.findElementByXPath("//*[@id=\"category\"]/ul/li[5]");
        ...
        for(int i=40; i<50; i++)
        {
           ...
           if (rate_num>=4.5&&review_num>100) {
              Check_Chicken_Store.main(name, rate_num, review_num, address);
           }
