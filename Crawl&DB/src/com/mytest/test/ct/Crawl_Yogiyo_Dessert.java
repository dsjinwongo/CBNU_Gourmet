...
import com.mytest.test.ct.Check_Dessert_Store;
...
public class Crawl_Yogiyo_Dessert{
   public static void main(String[] args) {
      // 현재 package의 workspace 경로, Windows는 [ chromedriver.exe ]
        ...
        WebElement menu=driver.findElementByXPath("//*[@id=\"category\"]/ul/li[13]");
        menu.click();
        ...
        for(int i=1; i<50; i++)
        {
           ...
           if (rate_num>=4.0&&review_num>50) {
              Check_Dessert_Store.main(name, rate_num, review_num, address);
           }
