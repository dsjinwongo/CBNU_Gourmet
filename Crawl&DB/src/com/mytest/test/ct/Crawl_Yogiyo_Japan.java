...
import com.mytest.test.ct.Check_Japan_Store;
...
public class Crawl_Yogiyo_Japan{
   public static void main(String[] args) {
      // 현재 package의 workspace 경로, Windows는 [ chromedriver.exe ]
        ...
        WebElement menu=driver.findElementByXPath("//*[@id=\"category\"]/ul/li[9]");
        menu.click();
        ...
        for(int i=6; i<50; i++)
        {
           ...
           if (rate_num>=4.0&&review_num>50) {
              Check_Japan_Store.main(name, rate_num, review_num, address);
           }
