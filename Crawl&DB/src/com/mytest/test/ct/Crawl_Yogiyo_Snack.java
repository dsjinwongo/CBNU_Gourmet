...
import com.mytest.test.ct.Check_Snack_Store;
...
public class Crawl_Yogiyo_Snack{
   public static void main(String args[]) {
      // 현재 package의 workspace 경로, Windows는 [ chromedriver.exe ]
        ...
        WebElement menu=driver.findElementByXPath("//*[@id=\"category\"]/ul/li[12]");
        menu.click();
        ...
        for(int i=20; i<50; i++)
        {
           ...
           if (rate_num>=4.0&&review_num>50) {
              Check_Snack_Store.main(name, rate_num, review_num, address);
           }
